...
import { useWebsocket, WavRecorder, WavStreamPlayer, RealtimeClient, FormattedItemType } from "shared_frontend";
...
const Realtime = () => {
    ...
    */
    ...
    useEffect(() => {
        ...
        rc.on('conversation.updated', ({ item, delta }: any) => {
            // TODO resolve pcm16 -> float32 -> play it ...

            setItems(rc.realtimeConversation)
        })
    }, [])
